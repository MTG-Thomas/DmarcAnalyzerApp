...
namespace DmarcAnalyzer.Api.Data.Migrations
{
    ...
    [Migration("20260812234953_RepairApiSourceCredentialUpgrade")]
    partial class RepairApiSourceCredentialUpgrade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("service_api_credential", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_service_api_credential_Permissions", "cardinality(\"Permissions\") BETWEEN 1 AND 8 AND \"Permissions\" <@ ARRAY['portfolio.read','alerts.manage','clients.manage','domains.manage','sources.manage','sources.sync','notifications.manage','audit.read']::text[]");
            ...
            modelBuilder.Entity("DmarcAnalyzer.Api.Data.Entities.UserPasskey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CredentialId")
                        .IsUnique()
                        .HasDatabaseName("UX_user_passkey_CredentialId");

                    b.HasIndex("UserId");

                    b.ToTable("user_passkey", null, t =>
                        {
                            t.HasCheckConstraint("CK_user_passkey_CredentialIdLength", "octet_length(\"CredentialId\") BETWEEN 16 AND 1023");

                            t.HasCheckConstraint("CK_user_passkey_PublicKeyLength", "octet_length(\"PublicKey\") BETWEEN 32 AND 4096");

                            t.HasCheckConstraint("CK_user_passkey_SignCount", "\"SignCount\" >= 0 AND \"SignCount\" <= 4294967295");

                            t.HasCheckConstraint("CK_user_passkey_UserHandleLength", "octet_length(\"UserHandle\") = 16");
                        });
                });
