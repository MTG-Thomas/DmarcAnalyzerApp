    ...
    public partial class RenameMailboxSourceToReportSource : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                """
                ALTER TABLE report_source
                    RENAME CONSTRAINT "CK_mailbox_source_ProtocolConfiguration"
                    TO "CK_report_source_ProtocolConfiguration";
                """);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                ALTER TABLE report_source
                    RENAME CONSTRAINT "CK_report_source_ProtocolConfiguration"
                    TO "CK_mailbox_source_ProtocolConfiguration";
                """);
