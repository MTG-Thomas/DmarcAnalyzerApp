...
public sealed class S3ReportSourceTransport(
    ...
    IOptions<ReportPayloadExtractionOptions> extractionOptions,
    ...
    int maxKeysPerPass = S3ReportSourceTransport.DefaultMaxKeysPerPass) : IPolledSourceTransport
{
    ...
    private readonly ReportPayloadExtractionOptions _extractionOptions = extractionOptions.Value;
        ...
        ReportSource source, string secret, CancellationToken ct)
    {
        ...
        try
        {
            ...
            return new S3ReadSession(
                ...
                ordered,
                pending,
                _extractionOptions.MaxExpandedBytes);
        }
        catch
        {
            client.Dispose();
